 ...
 *
 * Новостей и анонсов здесь намеренно нет. Для них есть публичный канал, и
 * дублировать его в личку значит присылать человеку одно и то же дважды,
 * причём вторым разом навязчивее.
 *
 * Общие темы по умолчанию выключены, личные включены. Общие это фоновый шум
 * сервера, а личные приходят редко и всегда про самого игрока.
 */
...
export const TOPICS: readonly Topic[] = [
  {
    id: "airdrop",
    title: "Айрдропы",
    hint: "дроп на грифе, каждый час круглосуточно",
    group: "Общие",
    scope: "global",
    // Двадцать четыре штуки в сутки, в том числе ночью. Включать такое всем
    // подряд значит попасть в мьют в первый же день.
    defaultOn: false,
  },
  {
    id: "dungeon",
  ...
  },
  {
    id: "seller",
    title: "Скупщик",
    hint: "новые заказы, ревизия склада, скачки цен",
    group: "Общие",
    scope: "global",
    defaultOn: false,
  },
  {
    id: "convoy",
    title: "Караваны",
    hint: "караван вышел в путь и его можно перехватить",
    group: "Общие",
    scope: "global",
    defaultOn: false,
  },
  {
    id: "lucky",
    title: "Лаки-блоки",
    hint: "призрачный блок на арене и джекпоты",
    group: "Общие",
    scope: "global",
    defaultOn: false,
  },
...
const EVENT_TO_TOPIC: Record<string, string> = {
  ...
  "market.night": "market",
  "afk.record": "records",
  // Скупщик и караваны разведены намеренно: цены интересны торговцам,
  // а вышедший караван это добыча, и ждут его совсем другие люди.
  "seller.event": "seller",
  "seller.convoy": "convoy",
  "seller.robbery": "convoy",
  "lucky.spawn": "lucky",
  "lucky.jackpot": "lucky",
